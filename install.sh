...
POST_PACK=("tmux" "net-tools" "htop" "jq" "fzf" "firefox-esr" "gvfs" "Thunar" "thunar-archive-plugin" "thunar-volman" "thunar-media-tags-plugin" "tumbler" "gnome-disk-utility" "pavucontrol" "xclip" "xarchiver" "elogind" "ntfs-3g")
...
sudo chown -R "$USER_NAME:$USER_NAME" "$USER_HOME/.Xauthority"
